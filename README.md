...
[![CircleCI Build Status](https://circleci.com/gh/wburillon/cicd-orb.svg?style=shield "CircleCI Build Status")](https://circleci.com/gh/wburillon/cicd-orb) [![CircleCI Orb Version](https://badges.circleci.com/orbs/wburillon/cicd-orb.svg)](https://circleci.com/developer/orbs/orb/wburillon/cicd-orb) [![GitHub License](https://img.shields.io/badge/license-MIT-lightgrey.svg)](https://raw.githubusercontent.com/wburillon/cicd-orb/master/LICENSE) [![CircleCI Community](https://img.shields.io/badge/community-CircleCI%20Discuss-343434.svg)](https://discuss.circleci.com/c/ecosystem/orbs)
...
[CircleCI Orb Registry Page](https://circleci.com/developer/orbs/orb/wburillon/cicd-orb) - The official registry page of this orb for all versions, executors, commands, and jobs described.

[CircleCI Orb Docs](https://circleci.com/docs/orb-intro/#section=configuration) - Docs for using, creating, and publishing CircleCI Orbs.

### How to Contribute

We welcome [issues](https://github.com/wburillon/cicd-orb/issues) to and [pull requests](https://github.com/wburillon/cicd-orb/pulls) against this repository!

### How to Publish An Update
1. Merge pull requests with desired changes to the main branch.
    - For the best experience, squash-and-merge and use [Conventional Commit Messages](https://conventionalcommits.org/).
2. Find the current version of the orb.
    - You can run `circleci orb info wburillon/cicd-orb | grep "Latest"` to see the current version.
3. Create a [new Release](https://github.com/wburillon/cicd-orb/releases/new) on GitHub.
